...
router.post('/create', [upload.single('image'), jwtauth], restaurants.insertRestaurant)
router.post('/delete', restaurants.deleteRestaurantAllData)
router.post('/update/:restId', upload.single('image'), restaurants.updateRestaurantData)
